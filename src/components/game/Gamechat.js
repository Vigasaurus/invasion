...
// const Gamechat = ({gameInfo, socket}) => {
// 	const [chatFilterVisible, updateChatFilterVisible] = useState(false)
// 	const [chatInputValue, updateChatInputValue] = useState('')
// 	const [isChatLocked, updateIsChatLocked] = useState(false)
